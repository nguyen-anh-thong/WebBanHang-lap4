...
namespace WebBanHang.Models
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Category { Id = 2, Name = "PS", DisplayOrder = 2 },
            new Category { Id = 3, Name = "Laptop", DisplayOrder = 3 });
            //seed data to table Product
            modelBuilder.Entity<Product>().HasData(
            new Product { Id = 1, Name = "Iphone ", Price = 300, CategoryId = 1 },
            new Product { Id = 2, Name = "Iphone 6s", Price = 350, CategoryId = 1 },
            ...
            new Product { Id = 11, Name = "ps4", Price = 750, CategoryId = 2 },
            new Product { Id = 12, Name = "ps5", Price = 1250, CategoryId = 2 });
        }
